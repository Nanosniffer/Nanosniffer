      ...
      <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center px-4 relative cyber-grid">
        <div className="w-full max-w-md bg-slate-900/90 border border-slate-800 p-8 rounded-2xl shadow-2xl glass-panel space-y-6">
          <div className="text-center space-y-2">
            <div className="w-full max-w-[280px] mx-auto rounded-2xl bg-white p-3 flex items-center justify-center shadow-lg border border-slate-700">
              <img src={acnLogo} alt="ACN - AI-Powered Criminal Network" className="w-full h-auto max-h-24 object-contain" />
            </div>
