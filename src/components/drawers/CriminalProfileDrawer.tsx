      ...
      <div className="w-full max-w-2xl bg-white h-full shadow-2xl border-l border-slate-200 flex flex-col animate-in slide-in-from-right duration-200">
          ...
          {activeTab === 'overview' && (
            <div className="space-y-3.5">
              ...
              <div className="p-3.5 rounded-lg bg-blue-50/70 border border-blue-200/80 space-y-1.5">
                ...
                <p className="text-[11px] text-blue-950/80 leading-relaxed font-sans">{criminal.aiThreatSummary}</p>
              </div>
              ...
              <div className="p-3.5 rounded-lg bg-slate-50 border border-slate-200 space-y-1.5">
                ...
                <p className="text-slate-700 leading-relaxed">{criminal.biography}</p>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                  ...
                  <div className="p-2.5 rounded-md bg-white border border-slate-200">
                    ...
                    <span className="text-slate-900 font-semibold">{criminal.personalDetails.dob}</span>
                  </div>
                  <div className="p-2.5 rounded-md bg-white border border-slate-200">
                  ...
                  <div className="p-2.5 rounded-md bg-white border border-slate-200">
                    ...
                    <span className="text-slate-900 font-semibold">{criminal.personalDetails.heightCm || 180} cm • {criminal.personalDetails.eyeColor || 'Brown'}</span>
                  </div>
                  <div className="p-2.5 rounded-md bg-white border border-slate-200">
                    <span className="text-slate-400 text-[10px] block">FINGERPRINT RECORD</span>
                    <span className="text-slate-900 font-mono font-semibold truncate block">{criminal.personalDetails.fingerprintId || 'FP-INTEL-881'}</span>
                  </div>
                  <div className="p-2.5 rounded-md bg-white border border-slate-200">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                <div className="p-3 rounded-md bg-white border border-slate-200 space-y-1">
                  ...
                  <div className="text-[10px] text-slate-400 font-mono">
                    [{criminal.lastKnownLocation.coordinates.join(', ')}]
                  </div>
                </div>
        ...
        <div className="p-3 px-5 border-t border-slate-200 bg-slate-50 flex items-center justify-between gap-3 shrink-0">
          <span className="text-[10px] font-mono text-slate-400">
            SNIFFER Intelligence Dossier • Defcon Level 2
          </span>
