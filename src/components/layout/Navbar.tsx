  ...
  return (
    <header className="h-14 sticky top-0 z-30 bg-white border-b border-slate-200 px-4 sm:px-6 flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-2.5 shrink-0">
        ...
        {/* 30-Minute Live Session Timeout & Auto-Relogin Countdown */}
        <div 
          onClick={extendSession}
          title={`Active Security Clearance Session: ${formatSessionTime(sessionSecondsLeft)} remaining (Auto-logout & re-login after 30 minutes). Click to extend +30m.`}
        ...
        >
          <Timer className={`w-3.5 h-3.5 shrink-0 ${sessionSecondsLeft <= 120 ? 'text-red-600' : 'text-blue-600'}`} />
