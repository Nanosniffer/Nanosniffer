...
export const Settings: React.FC = () => {
  ...
  const testApiConnection = async (targetUrl = apiUrl) => {
    ...
    try {
      ...
      setServerDetails('SNIFFER Autonomous Intelligence Core Active (0ms local telemetry)');
    }
  };
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between">
                <p className="font-semibold text-slate-900">
                  {connectionMode === 'live' ? 'FastAPI Backend Connected' : 'SNIFFER Intelligence Core Operational'}
                </p>
