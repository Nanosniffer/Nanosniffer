    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center items-center px-4 py-12">
      <div className="w-full max-w-md space-y-5">
        ...
        <div className="text-center">
          <div className="inline-flex items-center justify-center p-4 sm:p-5 rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-md transition-all duration-300 w-full max-w-[360px] sm:max-w-[400px] mx-auto">
            <img 
              src={acnLogo} 
              alt="ACN - AI-Powered Criminal Network" 
              className="w-full h-auto max-h-32 sm:max-h-36 object-contain drop-shadow-xs" 
            />
          </div>
        </div>
            ...
            <div className="space-y-3">
              ...
              <div className="pt-2">
                ...
                <Button
                  ...
                  className="w-full bg-slate-900 hover:bg-slate-800 text-white font-bold h-11 shadow-sm text-xs gap-2"
                >
                  {loading ? (
                    <span className="flex items-center gap-2">
                      <span className="w-3.5 h-3.5 border-2 border-white border-t-transparent rounded-full animate-spin" />
