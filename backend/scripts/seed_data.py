...
async def seed_database():
    ...
    try:
        ...
        users_data = [
            {
                "id": "usr-001",
                "email": "agent.patrick@nanosniff.gov",
                "hashed_password": get_password_hash("Password123!"),
                "name": "Agent Patrick Jane",
                "badge_number": "NS-0001",
                "role": "INVESTIGATOR",
                "clearance_level": "TOP SECRET // SCI",
                "agency": "NanoSniffer Cyber Task Force",
                "avatar_url": "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80",
            },
            {
                "id": "usr-002",
                "email": "admin@nanosniff.gov",
                "hashed_password": get_password_hash("AdminPass2026!"),
                "name": "Director Sujal Chauhan",
                "badge_number": "NS-000",
                "role": "ADMIN",
                "clearance_level": "TOP SECRET // SCI",
            ...
            {
                "id": "usr-003",
                "email": "analyst.taxil@nanosniff.gov",
                "hashed_password": get_password_hash("Password123!"),
                "name": "Senior Taxil",
                "badge_number": "NS-0002",
                "role": "ANALYST",
                "clearance_level": "SECRET",
                "agency": "NanoSniff Financial Crimes Telemetry Section",
